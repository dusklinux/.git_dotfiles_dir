...
# We ensure the script is run from the location containing 'dusk' to satisfy relative paths.
...
# TASK 2: Copy the 'dusk' Environment
# This creates /mnt/dusk
