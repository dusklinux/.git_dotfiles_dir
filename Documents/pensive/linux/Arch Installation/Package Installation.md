...
```
pacman -S --needed networkmanager iwd nm-connection-editor inetutils wget curl openssh firewalld vsftpd reflector bmon ethtool httrack filezilla qbittorrent wavemon firefox profile-sync-daemon arch-wiki-lite arch-wiki-docs
```
