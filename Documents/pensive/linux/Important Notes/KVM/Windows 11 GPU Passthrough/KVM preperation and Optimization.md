1. [[Verify  VT x and kernal modules and IOMMU]]
2. [[KVM Loading kernal Module]]
3. Optional only if you want to install it temperarrly.
	- [[Symbolic link to zram for image file]]
4. **Optional**  Use either one; Modular daemon or Monolithic daemon
...
9. **OPTIONAL** [[Set ACL on the Image Directory]]